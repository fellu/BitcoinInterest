...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Bitcoin Interest bootstrap mode. Allows BCI client to connect to Bitcoin p2p network to download blockahin history."));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fBCIBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
